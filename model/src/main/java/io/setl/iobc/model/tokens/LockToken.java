...
import io.setl.iobc.model.tokens.LockToken.Input;
 ...
 */
public interface LockToken extends IobcDelegate<Input, TransactionResult> {

  String NAME = "TOKEN.LOCK";



  /** Specification of what to lock. */
  @Builder
  @Value
  @Jacksonized
