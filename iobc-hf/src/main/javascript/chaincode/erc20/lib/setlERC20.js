...
const contractOrgMSPKey = 'ownermspid';
const contractOwnerKey = 'contractOwner';
const initializedKey = 'contractInitialized'
...
class SetlERC20Contract extends Contract {
    ...
    */
    ...
    async Mint(ctx, amount) {
        ...
        await ctx.stub.putState(contractOwnerKey, Buffer.from(minter));
