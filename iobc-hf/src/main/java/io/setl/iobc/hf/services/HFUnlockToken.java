...
@Service("hfUnlockToken")
@Slf4j
public class HFUnlockToken implements UnlockToken {

  private static final String FUNC_NAME = "LockToken";


  @Override
  public CompletableFuture<TransactionResult> apply(ChainConfiguration configuration, UnlockToken.Input input) throws ParameterisedException {
